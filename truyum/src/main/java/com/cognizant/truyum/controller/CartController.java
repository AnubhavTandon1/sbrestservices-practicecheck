...
public class CartController {
	...
	@GetMapping("/{userId}")
	public List<MenuItem> getAllCartItems(@PathVariable String userId) throws CartNullException, UserNotExistsException{
	...
	public void deleteCartItem(@PathVariable String userId,@PathVariable long menuItemId) throws UserNotExistsException, CartNullException, MenuItemNotFoundException
	{
